    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 1:
            if let interfaceType = NetStatus.shared.availableInterfacesTypes?[indexPath.row] {
                ...
                if let currentType = NetStatus.shared.interfaceType {
                    cell.indicationImageView.image = (interfaceType == currentType) ? UIImage(named: "checkmark") : nil
                }
            }
        case 2:
            cell.label?.text = NetStatus.shared.isExpensive ? "Expensive" : "Cheap"
